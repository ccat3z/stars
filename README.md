...
* [countstarlight/deepin-wine-qq-arch](https://github.com/countstarlight/deepin-wine-qq-arch): Tencent QQ on Deepin Wine5(com.qq.im.deepin) For Archlinux
...
* [WrBug/dumpDex](https://github.com/WrBug/dumpDex): 💯一款Android脱壳工具，需要xposed支持, 易开发已集成该项目。杭州有赞大量招聘Android、iOS工程师和实习生(22/23毕业)，有意向的可以加我联系方式 wx: iwrbug
...
* [alisternorris/file-dialog](https://github.com/alisternorris/file-dialog): Trigger the upload file dialog directly from your code easily.
...
* [vshn/k8up](https://github.com/vshn/k8up): Kubernetes and OpenShift Backup Operator
...
* [cvzi/rollup-userscript-template](https://github.com/cvzi/rollup-userscript-template): Bundle typescript, react and JSX/TSX script files into a single userscript file with rollup
...
* [siger-yeung/ropez](https://github.com/siger-yeung/ropez): RopeZ
